...
import IndicacionesView from "@/components/control/IndicacionesView";
...
export default function Control() {
  ...
  // Control accessible to all - admin actions protected within view
  // if (!isAdmin) {
  ...
  const [selectedUserDetail, setSelectedUserDetail] = useState<UserPermission | null>(null);
  ...
  const getTitle = () => {
    switch (view) {
      ...
      case "parametros":
        return "Indicaciones del Sistema";
      case "seguridad":
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 space-y-4 sm:space-y-6 max-w-6xl mx-auto">
      ...
      {/* Parametros View */}
      {view === "parametros" && <IndicacionesView />}
